...
AS OF 2023, THIS PROGRAM IS DEPRECATED. THE NHL CHANGED THEIR API ENDPOINTS, RENDERING THIS PROGRAM OBSOLETE. WORK IS CURRENTLY UNDERWAY TO UPDATE THE API CALLS AND DEPLOY THE PROGRAM TO A MORE ACCESSIBLE WEBSITE, STAY TUNED!
